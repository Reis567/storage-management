"""
Django settings for storage_management project.
...
SECRET_KEY = 'django-insecure-y_s@*ia$vm=tl7qaaf+jd5n@jc1=6!7z8md(do9p%!*=@86@a0'
...
WSGI_APPLICATION = 'storage_management.wsgi.application'
